...
async function autoInicioUsers() {
  ...
  try {
    const url = 'http://129.151.115.179:8080/api/user/all'
    // console.log(url)
...
async function consultarUser(id, email) {
  ...
  try {
    ...
    // debugger
    const url = 'http://129.151.115.179:8080/api/user/' + id
    // console.log(url)
    const response = await fetch(url);
...
async function createUser() {
  ...
  if (
    ...
    try {
      ...
      const urlUpdate = 'http://129.151.115.179:8080/api/user/new'
...
// debugger
      const urlUpdate = 'http://129.151.115.179:8080/api/user/update'
...
async function deleteUser(id, email) {
  ...
  try {
    ...
    const urlUpdate = 'http://129.151.115.179:8080/api/user/' + id
    const fetchOptions = {
      method: "DELETE",
    };
    const responseUpdate = await fetch(urlUpdate, fetchOptions);
