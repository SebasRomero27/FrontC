...
async function autoInicioProducts() {
    ...
    try {
        const url = 'http://129.151.115.179:8080/api/cookware/all'
        // console.log(url)
...
async function consultarProduct(price, reference) {
    ...
    try {
        ...
        // debugger
        const url = 'http://129.151.115.179:8080/api/cookware/' + reference
        // console.log(url)
        const response = await fetch(url);
        ...
        $("#dimensionesU").val(json.dimensiones)
...
async function createProduct() {
    ...
    if ($("#reference").val().length == 0 ||
        ...
        $("#materiales").val().length == 0 ||
        $("#dimensiones").val().length == 0 ||
        ...
        try {
            debugger
            let availability;
            const urlUpdate = 'http://129.151.115.179:8080/api/cookware/new'
...
async function updateProduct() {
    if ($("#referenceU").val().length == 0 ||
        ...
        try {
            ...
            const urlUpdate = 'http://129.151.115.179:8080/api/cookware/update'
...
async function deleteProduct(price, reference) {
    ...
    try {
        ...
        const urlUpdate = 'http://129.151.115.179:8080/api/cookware/' + reference
