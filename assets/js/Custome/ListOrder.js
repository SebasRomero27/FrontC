...
async function autoInicioOrdenes() {
  try {
    const url = 'http://129.151.115.179:8080/api/order/zona/' + sessionStorage.getItem('zona')
...
async function consultOrder(id) {
  ...
  try {
    ...
    // debugger
    const url = 'http://129.151.115.179:8080/api/order/' + id
    // console.log(url)
    const response = await fetch(url);
...
async function updateOrder(id) {
    ...
    try {
      const urlUpdate = 'http://129.151.115.179:8080/api/order/update'
